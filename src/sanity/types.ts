...
// Query: array::unique(*[_type == "project" && defined(tags)].tags[]->[defined(slug.current)]{ _id, name, "slug": slug.current })
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '\n  array::unique(*[_type == "project" && defined(tags)].tags[]->[defined(slug.current)]{ _id, name, "slug": slug.current })\n': PROJECTS_TAGS_QUERY_RESULT;
