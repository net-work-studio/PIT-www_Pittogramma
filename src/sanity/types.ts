...
// Query: *[_type == "tag" && defined(slug.current) && _id in *[_type == "project" && defined(slug.current) && defined(tags)].tags[]._ref] {    _id,    name,    "slug": slug.current,    "count": count(*[_type == "project" && defined(slug.current) && ^._id in tags[]._ref])  }
