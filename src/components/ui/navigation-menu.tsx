...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-full bg-background px-4 py-2 text-base outline-none transition-all hover:bg-foreground hover:text-background focus:bg-foreground focus:text-background focus-visible:outline-1 focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-foreground data-[state=open]:text-background data-[state=open]:focus:bg-foreground data-[state=open]:hover:bg-foreground"
);
...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      ...
      <ChevronDownIcon
        aria-hidden="true"
        className="relative top-[1px] ml-1 size-3 transition delay-0 duration-250 group-data-[state=open]:rotate-180"
      />
    </NavigationMenuPrimitive.Trigger>
  );
}
